...
context('MLB - Places - Mandatory - CNPJ', () => {
    before(() => {
        cy.setSite('MLB');
        cy.login();
    });
    ...
    context('Incentive', () => {
        ...
        describe('Validate landing content', () => {
            it('Initial state', () => {
                ...
                LandingPage.checkHeaderTitle(`A partir de ${activationDate}, você vai despachar suas vendas nas Agências Mercado Livre`);
                LandingPage.checkHeaderSubtitle('Você vai oferecer entregas no dia seguinte e seus anúncios terão o destaque “Chegará amanhã” se despachar até o horário que indicamos.');
                LandingPage.checkHeaderButtonContent('Ver agências próximas');
                ...
                LandingPage.checkBenefitsCards([
                    ...
                    {
                        text: 'Seus anúncios terão destaque no filtro “Chegará amanhã”.'
                    },
                    {
        ...
        describe.skip('Validate hub content', () => {
            before(() => {
                cy.setFlow(buildFlowData(
                    'MLB',
                    'PLACES',
